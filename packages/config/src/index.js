...
exports.PAGE_SIZE = exports.DEFAULT_SEARCH_RADIUS_KM = exports.GEO_PRECISION = exports.ESCROW_AUTO_RELEASE_HOURS = exports.QUOTE_EXPIRY_HOURS = exports.DEFAULT_COMMISSION_RATE = exports.FEATURE_FLAGS = void 0;
...
function getFirebaseConfig() {
    const envProjectId = process.env['EXPO_PUBLIC_FIREBASE_PROJECT_ID'] ?? process.env['FIREBASE_PROJECT_ID'] ?? '';
    // If env vars are present and not placeholders, use them
    if (envProjectId && !PLACEHOLDERS.has(envProjectId)) {
        const measurementId = process.env['EXPO_PUBLIC_FIREBASE_MEASUREMENT_ID'] ?? process.env['FIREBASE_MEASUREMENT_ID'];
        return {
...
exports.DEFAULT_COMMISSION_RATE = 0.12;
/** Quote expiry duration in hours */
exports.QUOTE_EXPIRY_HOURS = 24;
/** Escrow auto-release after provider completes (hours) */
exports.ESCROW_AUTO_RELEASE_HOURS = 48;
/** Geohash precision for provider search (6 ≈ 1.2km) */
exports.GEO_PRECISION = 6;
/** Default search radius in km */
exports.DEFAULT_SEARCH_RADIUS_KM = 20;
/** Pagination defaults */
